...
export default function BlogCard({ blog }) {
	return (
		<article className='transition-all border w-80 rounded-md text-muted-foreground hover:shadow-lg hover:border-gray-300'>
			<Link
			...
			>
				...
				<div className='flex justify-start mt-2 items-center gap-2'>
					<img className='w-6 h-6' src='src/assets/comment.svg' alt='comment' />
